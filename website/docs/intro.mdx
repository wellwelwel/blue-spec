...
| #   | Phase                                 | What it does for you                                                           |
| --- | ------------------------------------- | ------------------------------------------------------------------------------ |
| 1   | [**Charter**](/docs/commands/charter) | Sets your project's security rules, proposed for you or shaped by what you say |
| 2   | [**Detect**](/docs/commands/detect)   | Reads your code and maps what your system does and where the risks are         |
| 3   | [**Plan**](/docs/commands/plan)       | Turns what detect found into a defense plan, with a fix for each finding       |
| 4   | [**Harden**](/docs/commands/harden)   | Applies the plan's fixes to your code, safely and one at a time                |
| 5   | [**Verify**](/docs/commands/verify)   | Proves each applied fix holds and closes out the ones that do                  |
...
- Curious about the on-demand knowledge? Read about the [**specializations**](/docs/commands/skills).
