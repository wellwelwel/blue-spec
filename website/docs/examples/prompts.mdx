...
description: 'Copy-ready Lagune prompts: map and plan fixes, run the full Blue Team flow, or run a Zero Trust audit, each in a single-agent or parallel multi-agent variant.'
keywords:
  - lagune prompt
