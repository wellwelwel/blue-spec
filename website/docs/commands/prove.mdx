---
id: prove
title: '/lagune.prove: Defense-Only Proof of Concept'
sidebar_label: Prove
...
<Faq
  items={[
    {
      question: 'Does Lagune generate exploits?',
      answer:
    ...
    {
      question: 'What does prove output?',
      answer:
        'Two files per finding: a test (report.test.mjs or .cjs) and an advisory (report.md).',
    },
    {
      question: 'How do I responsibly disclose a bug Lagune found?',
      answer:
