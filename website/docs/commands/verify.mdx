---
id: verify
title: '/lagune.verify: Prove Security Controls Hold'
...
If the risk is not closed, verify says so plainly and sends you back to [`/lagune.harden`](/docs/commands/harden), since the fix is still open.
...
Verify builds on [`/lagune.harden`](/docs/commands/harden).
:::
...
<Faq
  items={[
    {
      question: 'How does Lagune verify a fix?',
      answer:
    ...
    {
      question: 'Can security work ever be finished?',
      answer:
