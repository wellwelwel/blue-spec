...
<Faq
  items={[
    {
      question: 'How do I add a custom security skill?',
      answer:
    ...
    {
      question: 'Can Lagune learn from an exploit write-up?',
      answer:
    ...
    {
      question: 'Does specialize overwrite built-in skills?',
      answer: 'No. It refines, never overwrites.',
    },
  ]}
/>
