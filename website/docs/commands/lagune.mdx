  ...
  items={[
    {
      ...
      answer:
        'It takes any prompt at any stage, builds what you asked, and makes it safe by default before handing it back. The defense is applied as the code is written, not later.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. It writes nothing to the .lagune directory, no artifact and no tracking. The only thing it produces is the safe code you asked for.',
    },
    {
