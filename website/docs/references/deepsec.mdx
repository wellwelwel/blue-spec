...
Some capabilities exist on only one side.

| Only in Lagune                                   | Only in Deepsec                                                               |
| ------------------------------------------------ | ----------------------------------------------------------------------------- |
| A ReDoS engine and SSRF address canonicalization | Deterministic SQLi, XSS, auth-bypass, and framework route/handler enumeration |
