...
id: skills-sources
title: OWASP Sources
sidebar_label: OWASP Sources
description: Where the built-in OWASP sub-skill knowledge comes from, mapped to its canonical OWASP attack and Cheat Sheet pages.
---
