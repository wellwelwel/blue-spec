---
id: install
title: 'Install: Security Hardening in Any Project via npx'
...
<Faq
  items={[
    {
      question: 'How do I install Lagune?',
      answer:
