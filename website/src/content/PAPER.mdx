...
**Blue Spec** is the reference implementation. It realizes SDH across 37 AI coding agents and proves the methodology is buildable and portable. SDH is offered as a convention others can adopt.
